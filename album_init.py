...
#print(db.execute('insert into albums(title) values(%s)', 'a\'bc').lastrowid)
...
#album_init('D:/music/Granbelm/[2019.09.11] TVアニメ「グランベルム」EDテーマ「願い」／Uru [AAC+MP3]')
#album_init(r'D:\music\Joshiraku\[120905]TVアニメ『じょしらく』EDテーマ「ニッポン笑顔百景」／桃黒亭一門[APE+CUE+BMP]')
#album_init(r'D:\music\Asagao to Kase-san\[180606] ｢明日への扉｣／山田結衣(CV.高橋未奈美)、加瀬友香(CV.佐倉綾音) [24bit_96kHz] (flac+webp)')
#album_init(r'D:\music\A Channel\A-CHANNEL THE ANIMATION Blu-ray Disc BOX -MUSIC CHANNEL- (FLAC)\Disc 2')
#album_init(r'D:\music\Gochuumon wa Usagi Desuka\[190926][Gochuumon wa Usagi Desuka Sing For You][Tokuten Hi-res Insert Song DVD][WAV]')